      ...
      <header className="absolute inset-x-0 top-0 z-30">
        <div className="shell-container flex items-center justify-between gap-3 py-5 sm:py-6">
          ...
          <nav className="flex items-center gap-2 sm:gap-3">
            ...
            <Link to="/login" className="hidden text-[13px] font-semibold text-[var(--muted)] transition hover:text-[var(--accent)] md:inline-flex">
              Secretariat
            </Link>
            <Link to="/register" className="btn-primary px-4 py-2.5 text-sm sm:px-5 sm:py-3">
              Register
